...
template<rbr::concepts::settings S> void check_contains_only(S const&)
{
  if constexpr (S::contains_only("value"_kw, "active"_fl)) std::cout << "Correct settings\n";
  else std::cout << "Incorrect settings\n";
}

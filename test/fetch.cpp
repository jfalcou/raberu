...
TTS_CASE("Check rbr::fetch behavior")
{
  ...
  TTS_EXPR_IS( (rbr::fetch("flop"_kw, coord_ = "Jane"s, value_ = 4.2f, is_modal_)), rbr::unknown_key  );
...
TTS_CASE("Check rbr::fetch_t behavior")
{
  using namespace std::literals;
  using namespace rbr::literals;

...
TTS_CASE("Check drop constexpr behavior")
{
  ...
  constexpr rbr::settings v(custom_ = foo{}, "surname"_kw = 'z', value_ = 3.f, "aligned"_fl, is_transparent_);
...
TTS_CASE("Check drop behavior")
{
  ...
  rbr::settings v(custom_ = foo{}, "surname"_kw = "john"s, value_ = 3.f, alg, is_transparent_);
